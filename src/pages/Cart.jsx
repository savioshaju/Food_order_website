...
const Cart = () => {
  ...
  return (
    <div className="bg-green-100 min-h-screen w-full pt-32 pb-16 px-4 relative">
      <button
        onClick={() => dispatch(clearCart(cartItems))}
        className='absolute flex flex-row gap-2 left-24 top-24 border border-green-600 rounded-xl px-4 py-2 text-green-700 hover:bg-green-400 hover:text-white whitespace-nowrap'>
        Clear
