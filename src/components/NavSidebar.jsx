      ...
      <div className="fixed w-56 min-h-screen bg-green-200 shadow-md px-6 py-20 space-y-4 top-0 left-0 bottom-0 z-30 overflow-y-auto hide-scrollbar">
        ...
        {userType === 'Seller' && (
          <>
            ...
            <Link className={getLinkClass('/Seller/manageRestaurants')} to="/Seller/ManageRestaurants">Manage Restaurants</Link>
            <Link className={getLinkClass('/Seller/ManageMenu')} to="/Seller/ManageMenu">Manage Menu</Link>
          </>
        )}
